                ...
                <div class="inner p-3">
                  <div class="card-body">
                    ...
                    <div class="temp-img d-sm-flex d-lg-block">
                      ...
                      <img src="${obj.current.condition.icon}" class="first-icon" alt="weather icon">                   
                    </div>
                ...
                <div class="inner p-3">
                  <div class="card-body pt-4">
                    <div class="temp-img text-center">
                      <img src="${obj.forecast.forecastday[1].day.condition.icon}" class="" alt="weather icon">                   
          ...
          <div class="col-12 col-lg-4">
              <div class="card h-100 main-bg" >
                ...
                <div class="inner p-3">
                  <div class="card-body pt-4">
                    <div class="temp-img text-center">
                      <img src="${obj.forecast.forecastday[2].day.condition.icon}" class="" alt="weather icon">                   
...
//   lonAndLAt.longitude = longitude
//   lonAndLAt.latitude = latitude
...
// }
// async function getLocationByLonAndLat(data,targetLon,targetLat){

//    for(const city in data){
//     let location = data[city].location


//     if (location.lon === targetLon && location.lat === targetLat) {
...
// getLocationByLonAndLat(data,lonAndLAt.log,lonAndLAt.lat)
